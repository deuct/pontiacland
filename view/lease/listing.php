        ...
        <script type="text/javascript">
            ...
            function getData() {
                $.ajax({
                    ...
                    url: "../../controller/lease/getlisting.php", //your page
                    dataType: 'json',
                        ...
                        if (res.status === 200) {
                            ...
                            for (let i = 0; i < data.length; i++) {
                                ...
                                trEl.innerHTML = `
                                    ...
                                    <td class="d-flex">
                                        <button type="button" class="btn btn-sm btn-primary me-2" onclick="window.location.href='./edit.php?leaseCode=` + data[i].lease_code + `'">Edit</button>
                                    </td>
                                `;
